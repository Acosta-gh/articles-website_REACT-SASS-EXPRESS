            ...
            <div className="content">
              ...
              <div className="content-comment">
                <div className="user">
                  ...
                  {/* Botón borrado */}
                  <button onClick = {() => onDelete(reply.id)}  className="btn btn-outline"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
